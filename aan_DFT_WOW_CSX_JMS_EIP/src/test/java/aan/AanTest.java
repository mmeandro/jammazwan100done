 ...
 * @version $Revision: 85 $
 */
public class AanTest extends CamelSpringTestSupport {
	...
	public void testOrderOk() throws Exception {
		...
		racoon.setWeight("14");
		racoon.setSpeed("73");
		Possum possom = template.requestBody("cxf:bean:entryEndpoint", racoon, Possum.class);
		assertEquals("medium", possom.getTorso());
